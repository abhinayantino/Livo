              ...
              Cancel
                ...
                >
                    <TextField
                        ...
                        onChange={(event) =>
                            updatePropertyfields(event, "userid")
                        }
                        variant="standard"
                        style={{
                            fontFamily: "Barlow",
                    ...
                    <div>
                        <TextField
                            ...
                            onChange={(event) =>
                                updatePropertyfields(event, "firstname")
                            }
                            variant="standard"
                            style={{
                                fontFamily: "Barlow",
                        ...
                        <TextField
                            ...
                            onChange={(event) =>
                                updatePropertyfields(event, "lastname")
                            }
                            variant="standard"
                            style={{
                                fontFamily: "Barlow",
                    ...
                    <TextField
                        ...
                        onChange={(event) =>
                            updatePropertyfields(event, "usertype")
                        }
                        variant="standard"
                    >
                        {cities.map((option) => (
                    ...
                    <TextField
                        ...
                        onChange={(event) =>
                            updatePropertyfields(event, "nationalityid")
                        }
                        variant="standard"
                        style={{
                            fontFamily: "Barlow",
                    ...
                    <TextField
                        ...
                        onChange={(event) =>
                            updatePropertyfields(event, "passportno")
                        }
                        variant="standard"
                        style={{
                            fontFamily: "Barlow",
                    ...
                    <TextField
                        ...
                        onChange={(event) =>
                            updatePropertyfields(event, "Email")
                        }
                        variant="standard"
                        style={{
                            fontFamily: "Barlow",
