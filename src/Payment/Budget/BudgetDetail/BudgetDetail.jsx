...
import "../index.css";
import TotalBudgetDetailtable from "../../../components/TotalBudgetDetailtable";
import IncomeBudgetDetailtable from "../../../components/IncomeBudgetDetailtable";
import ExpensesBudgetDetailtable from "../../../components/ExpensesBudgetDetailtable";
const BudgetDetail = () => {
            ...
            <div className="p-4">
                <div className="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button className="editbudgetdetail">
                            Edit Budget
                        </button>
                    </div>
                </div>
                <div className=" d-flex gap-3 mt-4">
                    <button
                        className={active === "total" ? "active" : "inactive"}
                        onClick={() => setActive("total")}
                    >
                        Total
                    </button>
                    <button
                        className={active === "income" ? "active" : "inactive"}
                        onClick={() => setActive("income")}
                    >
                        Income
                    </button>
                    <button
                        className={active === "expense" ? "active" : "inactive"}
                ...
                <div className="mt-5">
                    {active === "total" && <TotalBudgetDetailtable />}
                    {active === "income" && <IncomeBudgetDetailtable />}
                    {active === "expense" && <ExpensesBudgetDetailtable />}
                </div>
            </div>
        </div>
    );
