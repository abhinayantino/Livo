  ...
  return (
    <div className="home">
      <div className="Property-top">
        ...
        <div
          className="user-vacant"
          style={{ color: "#C24C4C", width: "108px", height: "27px" }}
        >
          Maintainence
        </div>
      ...
      >
        ...
        <div className="details" style={{ position: "absolute", top: "42rem" }}>
          Add Resident User
        </div>
        ...
        />
        <div style={{ position: "absolute", top: "64rem", left: "21.5rem" }}>
          Can not add Resident in a Unit that is marked as Under Maintainence
        </div>
